...
const Users = () => {
  ...
  useEffect(() => {
    axios.get(`https://go-cabs-backend.onrender.com/getusers`)
      .then((response) => {
  ...
  const deleteData = (taskId) => {
    axios.delete(`https://go-cabs-backend.onrender.com/userdelete/${taskId}`);
    window.location.assign('/users');
    alert('User is deleted');
  };

  const deletecar = (taskId) => {
    axios.delete(`https://go-cabs-backend.onrender.com/usercardelete/${taskId}`);
    window.location.assign('/users');
    alert('deleted');
  };

  const fetchUserBikeData = (userId) => {
    axios.get(`https://go-cabs-backend.onrender.com/getrides/${userId}`)
      .then((response) => {
